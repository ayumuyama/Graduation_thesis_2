...
if __name__ == "__main__":
    ...
    # 戻り値のアンパックを修正 (mem_var_1 を追加)
    acc_hist_1, spk_t_1, spk_i_1, F_set1, C_set1, W_out_set1, b_out_set1, mem_var_1 = appNIST.train_readout_mnistc_Retrain(
        F_initial, C_initial, W_out_initial, b_out_initial, X_train, y_train, Nneuron, Nx, Nclasses, dt, leak, Thresh, Gain, epsf, epsr, alpha, beta, mu,
    ...
    # 戻り値のアンパックを修正 (mem_var_2 を追加)
    acc_hist_2, spk_t_2, spk_i_2, *_, mem_var_2 = appNIST.train_readout_mnistc_Retrain(
        F_set1, C_set1, W_out_set1, b_out_set1, X_test, y_test, Nneuron, Nx, Nclasses, dt, leak, Thresh, Gain, epsf, epsr, alpha, beta, mu, 
        Duration=Duration, lr_readout=lr_readout
    )
