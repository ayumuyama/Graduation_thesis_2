...
if __name__ == "__main__":
    ...
    X, y = appssian.generate_continuous_shift_dataset(n_train=50000, n_test=100000, nx=2, sigma=5, seed=30,
                                      train_params={'mean': [0.0, 0.0], 'std': 1.0},
                                      test_params={'mean': [0.0, 0.0], 'std': [2.0, 1.0]})
    ...
    acc_hist_1, spk_t_1, spk_i_1, F_set1, C_set1, W_out_set1, b_out_set1, mem_var_1, final_states_1 = appssian.test_train_continuous_soft(
        ...
        retrain=True, Gain=10000, lr_readout=lr_readout, init_states=None, sigma_wta=5.0 # 最初は指定なし
    )
    ...
    acc_hist_2, spk_t_2, spk_i_2, *_, mem_var_2, final_states_2 = appssian.test_train_continuous_soft(
        F_set1, C_set1, W_out_set1, b_out_set1, X_test, y_test, Nneuron, Nx, Nclasses, dt, leak, Thresh, epsf, epsr, alpha, beta, mu,
        retrain=True, Gain=10000, lr_readout=lr_readout, init_states=final_states_1, sigma_wta=5.0 # ★ここで引き継ぎ！
    )
